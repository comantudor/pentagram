        ...
        return (
            <div>
                {sessionStorage.getItem('authToken') != null ?
                    <span className="userLogedLabel">Hello {self.state.loggedUsername}</span> : ''}
                <div className="container">
                    <div className="row">
                        <div className="col-md-5">
                            <img className="img-rounded photo-img"
                                 src={'http://127.0.0.1:8000' + self.state.image.photo} width="100%"/>
                            <span className="like-icon glyphicon glyphicon-thumbs-up"
                                  onClick={self.onLikeHandler}></span>
                        ...
                        <div className="col-md-7 well">
                            ...
                            {sessionStorage.getItem('authToken') != null ?
                                <textarea placeholder="Add Comment" className="form-control" id="commentContent"/> : ''}
                            {sessionStorage.getItem('authToken') != null ?
                                <button className="btn btn-default col-sm-offset-3 col-sm-9" name="submit"
                                        onClick={self.onCommentHandler}>Add</button> : '' }
